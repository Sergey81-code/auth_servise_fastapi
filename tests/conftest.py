...
async def run_migrations():
    ...
    subprocess.run([alembic_cmd, "-c", alembic_ini_path, "revision", "--autogenerate", "-m", '"test running migrations"'], check=True)
    
    subprocess.run([alembic_cmd, "-c", alembic_ini_path, "upgrade", "heads"], check=True)
